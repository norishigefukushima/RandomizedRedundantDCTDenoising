...
The DCT is based on the fastest algorithm[3,4] and SIMD vectorization is also performed.
...
Optionally, we can use DHT (discrete Walsh–Hadamard fransform) for fast computation instead of using DCT.
...
* [3] C. Loeffler, A. Ligtenberg, and G. S. Moschytz, "Practical fast 1-D DCT algorithms with 11 multiplications," Proc. Int'l. Conf. on Acoustics, Speech, and Signal Processing (ICASSP89), pp. 988-991, 1989.
